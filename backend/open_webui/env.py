...
WEBUI_NAME = os.environ.get("WEBUI_NAME", "DeepMatrix")
if WEBUI_NAME != "DeepMatrix":
    WEBUI_NAME += " (DeepMatrix)"

WEBUI_FAVICON_URL = "https://chat.neverforever.space/favicon.png"
